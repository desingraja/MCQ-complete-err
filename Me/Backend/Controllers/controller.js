...
exports.qst1 = (req,res)=>{
// bodyparser
console.log("creating")
// save
design.save(function(err,data){
    if(err){
        console.log("ERR")
    }
    if(data){
...
exports.userlog = (req, res) => {
    ...
    userssignup_schema.findOne({"name":req.body.name})
    .then(data=>{
        console.log(data);
        jwt.verify((data.pwd,'req.body.pwd'),function(err,data){
            if(data){
          console.log("decoded");
            }
